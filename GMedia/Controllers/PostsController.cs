...
namespace GMedia.Controllers
{
    public class PostsController : Controller
    {
        ...
        private readonly ILogger<PostsController> _logger; // Add this field

        public PostsController(ApplicationDbContext context, UserManager<User> userManager, ILogger<PostsController> logger) // Update constructor
        {
            _context = context;
